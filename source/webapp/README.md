...
The Media Insights Engine (MIE) project includes a demo application for content analysis. It provides a GUI for configuring MIE workflows, running workflows, and analyzing the metadata generated by said workflows. It was built with [Vue.js](https://vuejs.org). 
